...
namespace PlanejaOdonto.Api.Services
{
    public class FinancialService : IFinancialService
    {
        ...
        public FinancialService(IExpenseRepository expenseRepository, IExpenseGroupRepository expenseGroupRepository, IIncomeRepository incomeRepository, IUnitOfWork unitOfWork, IMapper mapper)
        {
        ...
        public async Task<ExpenseGroupResponse> UpdateExpenseGroupAsync(int id, ExpenseGroup expenseGroup)
        {
            ...
            //existingExpenseGroup.Email = expenseGroup.Email;
            //existingExpenseGroup.Phone = expenseGroup.Phone;
