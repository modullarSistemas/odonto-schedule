...
namespace PlanejaOdonto.Api.Migrations
{
    ...
    [Migration("20220206000221_date-in-finance")]
    partial class dateinfinance
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlanejaOdonto.Api.Domain.Models.TreatmentAggregate.Anamnesis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PlanejaOdonto.Api.Domain.Models.TreatmentAggregate.Anamnesis", b =>
                {
                    b.HasOne("PlanejaOdonto.Api.Domain.Models.TreatmentAggregate.Treatment", "Treatment")
                        .WithOne("Anamnesis")
                        .HasForeignKey("PlanejaOdonto.Api.Domain.Models.TreatmentAggregate.Anamnesis", "TreatmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
